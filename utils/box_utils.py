...
def bbox_iou(box1, box2, x1y1x2y2=True):
    ...
    inter_rect_x1 = ops.maximum(b1_x1, b2_x1)
    inter_rect_y1 = ops.maximum(b1_y1, b2_y1)
    inter_rect_x2 = ops.minimum(b1_x2, b2_x2)
    inter_rect_y2 = ops.minimum(b1_y2, b2_y2)
    # Intersection area
    #pdb.set_trace()
    inter_area = ops.clamp(inter_rect_x2 - inter_rect_x1, min=0) * ops.clamp(inter_rect_y2 - inter_rect_y1, min=0)
    # Union Area
