...
class torch_bert(nn.Module):
    def __init__(self, name: str, train_bert: bool, hidden_dim: int, max_len: int, enc_num):
        ...
        bert_config = AutoConfig.from_pretrained('/home/zhangjiahua/Code/Pseudo-Q_old/models/uncased_Bert')
    ...
    def forward(self, tensor_list: NestedTensor):
        ...
        if self.enc_num > 0:
            output = self.bert(tensor_list.tensors, token_type_ids=None, attention_mask=tensor_list.mask)
...
def build_bert(args):
    ...
    bert = torch_bert(args.bert_model, train_bert, args.hidden_dim, args.max_query_len, args.bert_enc_num)
